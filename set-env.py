...
ENV_VARS = ['DATABASE_URI', 'SESSION_SECRET', 'JWT_ALGORITHM', 'IMAGE_S3_ACCESS_KEY_ID', 'IMAGE_S3_SECRET_ACCESS_KEY', 'LAMBDA_ACCESS_KEY_ID', 'LAMBDA_SECRET_ACCESS_KEY', 'FIRST_SUPERUSER', 'FIRST_SUPERUSER_PASSWORD']
